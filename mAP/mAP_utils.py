'''
get mAP from txt files 
report AP at IOU = 0.50:0.95
'''
import glob
import json
import os
...
if __name__ == "__main__":
    ...
    parser.add_argument('-q', '--quiet', help="minimalistic console output.", action="store_true",default=True)
...
def ap_iou(MINOVERLAP = 0.5):
    ...
    with open(output_files_path + "/output.txt", 'w') as output_file:
        ...
        for class_index, class_name in enumerate(gt_classes):
            ...
            f = 2/(1/r+1/p)
            ######################### show  f1  score  #################################
            # print('recall: {:.4f} precision: {:.4f} f1 score: {:.4f}'.format(r,p,f))
            # return 0
            # assert 0 
        ...
        text = "AP at IOU{:.2f} = {:.2f}%".format(MINOVERLAP,mAP*100)
        output_file.write(text + "\n")
        print(text)
